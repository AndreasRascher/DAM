codeunit 110014 DMTImportNEW
{
    ...
    var
        ...
        TempFieldMapping_COLLECTION: Record "DMTFieldMapping" temporary;
    ...
    begin
        ...
        LoadFieldMapping(DMTDataFile, IsUpdateTask, TempFieldMapping_COLLECTION);

        // Buffer loop
        if DMTDataFile.BufferTableType = DMTDataFile.BufferTableType::"Generic Buffer Table for all Files" then begin
            GenBuffTable.InitFirstLineAsCaptions(DMTDataFile.RecordId);
    ...
    procedure LoadFieldMapping(DataFile: Record DMTDataFile; UseToFieldFilter: Boolean; var TempDMTFields_FOUND: Record "DMTFieldMapping" temporary) OK: Boolean
    var
        FieldMapping: Record "DMTFieldMapping";
        tempDMTFields: Record "DMTFieldMapping" temporary;
    begin
    ...
    begin
        ...
        if DataFile.BufferTableType = DataFile.BufferTableType::"Generic Buffer Table for all Files" then begin
            if not DMTGenBuffTable.FindSetLinesByFileNameWithoutCaptionLine(DataFile.RecordId) then
                exit;
