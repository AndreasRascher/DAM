codeunit 73008 DMTMigrationLib
{
    ...
    begin
        if DataFile."Target Table ID" in [Database::"Dimension Value", Database::Dimension, Database::"Dimension Set Entry", Database::"Dimension Set Tree Node"] then
