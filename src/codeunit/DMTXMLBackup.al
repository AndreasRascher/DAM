codeunit 73016 DMTXMLBackup
{
    ...
    begin
        ...
        // TablesToExport.Add(Database::DMTReplacementsHeaderOLD);
        // TablesToExport.Add(Database::DMTReplacementsLineOLD);
        TablesToExport.Add(Database::DMTReplacement);
